...
DIFFICULTY_PRESETS: dict[int, dict[str, object]] = {
  1: dict(
    ...
    goal_yaw=(0.0, 0.0),
    pendulum_reset=(0.0, math.radians(0.0)),
    pendulum_limits=(math.radians(-10.0), math.radians(10.0)),
    pendulum_terminate_angle=math.radians(7.0),
    pendulum_terminate_duration=0.1,
  ...
  2: dict(
    ...
    pendulum_reset=(0.0, math.radians(5.0)),
    pendulum_limits=(math.radians(-10.0), math.radians(10.0)),
    pendulum_terminate_angle=math.radians(7.0),
    pendulum_terminate_duration=0.1,
  ...
  3: dict(
    ...
    pendulum_reset=(0.0, math.radians(9.9)),
    pendulum_limits=(math.radians(-10.0), math.radians(10.0)),
    pendulum_terminate_angle=math.radians(7.0),
    pendulum_terminate_duration=0.1,
  ...
  4: dict(
    ...
    pendulum_reset=(math.radians(5.0), math.radians(9.9)),
    pendulum_limits=(math.radians(-10.0), math.radians(10.0)),
    pendulum_terminate_angle=math.radians(7.0),
    pendulum_terminate_duration=0.1,
  ...
  5: dict(
    ...
    pendulum_reset=(math.radians(9.8), math.radians(9.9)),
    pendulum_limits=(math.radians(-10.0), math.radians(10.0)),
    pendulum_terminate_angle=math.radians(7.0),
    pendulum_terminate_duration=0.1,
    position_tolerance=0.2,
